...
export default function FuturePlans() {
  ...
  return (
    <section id="future" className="relative min-h-screen w-full flex items-center justify-center py-24 bg-slate-900 border-t border-slate-800 overflow-hidden">
